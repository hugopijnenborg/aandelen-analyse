...
const SECTOR_PE_RANGES = {
  'SaaS':              { zones: [15, 35, 50, 65], labels: ['< 15', '15–35', '35–50', '50–65', '> 65'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'AI Software':       { zones: [15, 40, 60, 80], labels: ['< 15', '15–40', '40–60', '60–80', '> 80'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'AI Infrastructuur': { zones: [12, 35, 50, 65], labels: ['< 12', '12–35', '35–50', '50–65', '> 65'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Semiconductors':    { zones: [10, 30, 42, 55], labels: ['< 10', '10–30', '30–42', '42–55', '> 55'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Cybersecurity':     { zones: [15, 40, 58, 75], labels: ['< 15', '15–40', '40–58', '58–75', '> 75'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Cloud':             { zones: [15, 35, 50, 65], labels: ['< 15', '15–35', '35–50', '50–65', '> 65'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Datacenters':       { zones: [10, 30, 42, 55], labels: ['< 10', '10–30', '30–42', '42–55', '> 55'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Financials':        { zones: [5,  18, 25, 32],  labels: ['< 5',  '5–18',  '18–25', '25–32', '> 32'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Industrials':       { zones: [8,  25, 35, 45],  labels: ['< 8',  '8–25',  '25–35', '35–45', '> 45'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Energy':            { zones: [4,  15, 22, 30],  labels: ['< 4',  '4–15',  '15–22', '22–30', '> 30'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Utilities':         { zones: [8,  20, 28, 38],  labels: ['< 8',  '8–20',  '20–28', '28–38', '> 38'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Consumer':          { zones: [8,  25, 35, 45],  labels: ['< 8',  '8–25',  '25–35', '35–45', '> 45'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Healthcare':        { zones: [8,  25, 35, 45],  labels: ['< 8',  '8–25',  '25–35', '35–45', '> 45'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Pharma':            { zones: [6,  20, 30, 40],  labels: ['< 6',  '6–20',  '20–30', '30–40', '> 40'], colors: ['#15803d', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
  'Biotech':           { zones: [0,  25, 40, 60],  labels: ['Verlies', '< 25', '25–40', '40–60', '> 60'], colors: ['#ef4444', '#22c55e', '#eab308', '#f97316', '#ef4444'] },
}
